...
export const PostsApiFp = {
     ...
     * @param id 
     */
    getUnpublishedPost(params: { "id": number;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CmsUnpublishedPost> {
     ...
     * @param slug 
     */
    getUnpublishedPostBySlug(params: { "slug": string;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CmsUnpublishedPost> {
...
export const RegisterApiFetchParamCreator = {
     ...
     * @param body 
     */
    verifyNewUser(params: {  "body": CmsVerifyNewUserRequest; }, options?: any): FetchArgs {
        // verify required parameter "body" is set
        if (params["body"] == null) {
...
export const RegisterApiFp = {
     ...
     * @param body 
     */
    verifyNewUser(params: { "body": CmsVerifyNewUserRequest;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CmsUserRequest> {
...
export class RegisterApi extends BaseAPI {
     ...
     * @param body 
     */
    verifyNewUser(params: {  "body": CmsVerifyNewUserRequest; }, options?: any) {
